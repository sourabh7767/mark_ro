...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Valley Wide Collision admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
        <meta name="keywords" content="admin template, Valley Wide Collision admin template, dashboard template, flat admin template, responsive admin template, web app">
                ...
                <div class="content-body">
                    <div class="auth-wrapper auth-cover">
                        <div class="auth-inner row m-0">
                            ...
                            <!-- Brand logo-->
                            <a class="brand-logo" href="{{ url(request()->getRequestUri()) }}">
                                ...
                                <h2 class="brand-text text-primary ms-1">Valley Wide Collision</h2>
                            </a>
                            <!-- /Brand logo-->
                            <!-- Left Text-->
