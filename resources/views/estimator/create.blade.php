...
@section('title') Create Estimator @endsection
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Create Estimator
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Create Estimator</h4>
                                </div>
                                <div class="card-body">
                                  <form method="POST" action="{{ route('estimators.store') }}">
                                    @csrf
                                        <div class="row">
